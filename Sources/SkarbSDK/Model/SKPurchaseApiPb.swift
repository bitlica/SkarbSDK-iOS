...
struct Purchaseapi_VerifyReceiptRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Purchaseapi_VerifyReceiptResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var activeSubscriptions: [Purchaseapi_ActiveSubscription] = []
...
struct Purchaseapi_ActiveSubscription {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasExpiryDate: Bool {return self._expiryDate != nil}
  /// Clears the value of `expiryDate`. Subsequent reads from it will return its default value.
  mutating func clearExpiryDate() {self._expiryDate = nil}

  var productID: String = String()

  var quantity: Int32 = 0

  var introOfferPeriod: Bool = false
...
struct Purchaseapi_NonSubscription {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Purchaseapi_VerifyReceiptRequest: @unchecked Sendable {}
...
extension Purchaseapi_VerifyReceiptRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".VerifyReceiptRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "auth"),
    2: .standard(proto: "install_id"),
  ...
  static func ==(lhs: Purchaseapi_VerifyReceiptRequest, rhs: Purchaseapi_VerifyReceiptRequest) -> Bool {
    if lhs._auth != rhs._auth {return false}
    if lhs.installID != rhs.installID {return false}
...
extension Purchaseapi_VerifyReceiptResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".VerifyReceiptResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.activeSubscriptions.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.activeSubscriptions, fieldNumber: 2)
    }
  ...
  static func ==(lhs: Purchaseapi_VerifyReceiptResponse, rhs: Purchaseapi_VerifyReceiptResponse) -> Bool {
...
extension Purchaseapi_ActiveSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ActiveSubscription"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "transaction_id"),
    2: .standard(proto: "original_transaction_id"),
    3: .standard(proto: "expiry_date"),
    4: .standard(proto: "product_id"),
    5: .same(proto: "quantity"),
    6: .standard(proto: "intro_offer_period"),
    7: .standard(proto: "trial_period"),
    8: .standard(proto: "renewal_info"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.originalTransactionID) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._expiryDate) }()
      ...
      case 6: try { try decoder.decodeSingularBoolField(value: &self.introOfferPeriod) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.trialPeriod) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self.renewalInfo) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.originalTransactionID.isEmpty {
      try visitor.visitSingularStringField(value: self.originalTransactionID, fieldNumber: 2)
    }
    ...
    if self.introOfferPeriod != false {
      try visitor.visitSingularBoolField(value: self.introOfferPeriod, fieldNumber: 6)
    }
    if self.trialPeriod != false {
      try visitor.visitSingularBoolField(value: self.trialPeriod, fieldNumber: 7)
    }
    if !self.renewalInfo.isEmpty {
      try visitor.visitSingularStringField(value: self.renewalInfo, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Purchaseapi_ActiveSubscription, rhs: Purchaseapi_ActiveSubscription) -> Bool {
    ...
    if lhs.introOfferPeriod != rhs.introOfferPeriod {return false}
    if lhs.trialPeriod != rhs.trialPeriod {return false}
    if lhs.renewalInfo != rhs.renewalInfo {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Purchaseapi_NonSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NonSubscription"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "transaction_id"),
    2: .standard(proto: "original_transaction_id"),
    3: .standard(proto: "purchase_date"),
    4: .standard(proto: "product_id"),
    5: .same(proto: "quantity"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularStringField(value: &self.transactionID) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.originalTransactionID) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._purchaseDate) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.productID) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.quantity) }()
      default: break
      }
  ...
  static func ==(lhs: Purchaseapi_NonSubscription, rhs: Purchaseapi_NonSubscription) -> Bool {
    if lhs.transactionID != rhs.transactionID {return false}
    if lhs.originalTransactionID != rhs.originalTransactionID {return false}

...
//TODO:
//extension Purchaseapi_VerifyReceiptRequest: SKCodableStruct {
// 
//  static func createRequest() -> Purchaseapi_VerifyReceiptRequest {
//    return Purchaseapi_VerifyReceiptRequest.with({
//      $0.auth = Auth_Auth.createDefault()
//      $0.installID = SkarbSDK.getDeviceId()
//      if let appStoreReceiptURL = Bundle.main.appStoreReceiptURL,
//         let recieptData = try? Data(contentsOf: appStoreReceiptURL) {
//        $0.receipt = recieptData
//      } else {
//        $0.receipt = Data()
//        SKLogger.logError("Create purchase for V4. recieptData is nil",
//                          features: [SKLoggerFeatureType.internalError.name: SKLoggerFeatureType.internalError.name])
...
//    let receipt = try container.decode(Data.self, forKey: .receipt)
//    
//    self = Purchaseapi_VerifyReceiptRequest.with({
//      $0.auth = auth
//      $0.installID = installID
//      $0.receipt = receipt
//    })
